...
void ScaleDialog::on_factorEdit_editingFinished()
{
    if(ui->factorEdit->hasFocus()){
        ...
        if(value < 0.1f || value > 2000.0f) {
            QMessageBox::information(this, tr("错误"), tr("要求输入值在0.1~2000之间"));
            if(value < 0.1f) {
                ui->factorEdit->setText("1");
                value = 0.1f;
            } else {
                ui->factorEdit->setText("2000");
                value = 2000.0f;
            }
        }
...
void ScaleDialog::on_zoomInButton_clicked()
{
    ...
    if(curScale < 0.2) {
    ...
    else if(curScale < 0.3) {
        factor = 0.3;
        ui->factorEdit->setText("0.2");
    }
    else if(curScale < 0.4){
        factor = 0.4;
        ...
        factor = 4;
        ui->factorEdit->setText("4");
    }
    else if(curScale < 5) {
        factor = 5;
        ui->factorEdit->setText("5");
    }
    else if(curScale < 6.25) {
        factor = 6.25;
        ui->factorEdit->setText("6.25");
    }
    else if(curScale < 8.3) {
        factor = 8.3;
        ui->factorEdit->setText("8.3");
    }
    else if(curScale < 12.5) {
        factor = 12.5;
        ui->factorEdit->setText("12.5");
    }
    else if(curScale < 16.67) {
        factor = 16.67;
        ui->factorEdit->setText("16.67");
    }
    else if(curScale < 33.33) {
        factor = 33.33;
        ui->factorEdit->setText("33.33");
    }
    else if(curScale < 50) {
        factor = 50;
        ui->factorEdit->setText("50");
    }
    else if(curScale < 66.67) {
        factor = 66.67;
        ui->factorEdit->setText("66.67");
    }
    else if(curScale < 100) {
        factor = 100;
        ui->factorEdit->setText("100");
    }
    else if(curScale < 200) {
        factor = 200;
        ui->factorEdit->setText("200");
    }
    else if(curScale < 300) {
        factor = 300;
        ui->factorEdit->setText("300");
    }
    else if(curScale < 400) {
        factor = 400;
        ui->factorEdit->setText("400");
    }
    else if(curScale < 500) {
        factor = 500;
        ui->factorEdit->setText("500");
    }
    else if(curScale < 600) {
        factor = 600;
        ui->factorEdit->setText("600");
    }
    else if(curScale < 700) {
        factor = 700;
        ui->factorEdit->setText("700");
    }
    else if(curScale < 800) {
        factor = 800;
        ui->factorEdit->setText("800");
    }
    else if(curScale < 1200) {
        factor = 1200;
        ui->factorEdit->setText("1200");
    }
    else if(curScale < 1600) {
        factor = 1600;
        ui->factorEdit->setText("1600");
    }
    else if(curScale < 2000) {
        factor = 2000;
        ui->factorEdit->setText("2000");
    }
